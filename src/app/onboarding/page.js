...
const SECTIONS = [
    ...
    questions: [
      {
        code: "4.1",
        title:
          "Are you interested in discussing any of the following RX (prescription) treatments with your Cyborg clinical team?",
        subtitle:
  ...
  },
  {
    ...
    questions: [
      ...
      {
        code: "5.2",
        title: "What are you most hoping to accomplish with Cyborg?",
        subtitle: "Select all that apply.",
        type: "multi",
        options: [
  ...
  useEffect(() => {
    const fetchQuestionnaire = async () => {
      try {
        ...
        setSections(withDob(valid ? raw : SECTIONS));
      } catch (err) {
